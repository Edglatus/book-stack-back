...
describe("Local System Test", () => {
    ...
    TestSystemRouting<iUser>("User Routes", "/user", newUser_a, newUser_b, updatedUser);
    ...
    TestSystemRouting<iAuthor>("Author Routes", "/author", newAuthor_a, newAuthor_b, updatedAuthor);
    ...
    TestSystemRouting<iBook>("Book Routes", "/book", newBook_a, newBook_b, updatedBook);
});
